...
export function PainelQuestao({ 
  ...
  return (
    <div className="p-6">
      ...
      <div className="flex items-start justify-between mb-6">
        <div className="flex-1">
          ...
          <p className="text-sm text-slate-600 dark:text-slate-400">
            {exercicio.titulo} • {exercicio.tipo === "pratico" ? "Exercício Prático" : "Quiz"}
          </p>
        </div>
      ...
      {/* Código de exemplo para exercícios práticos */}
          ...
          <div className="bg-slate-50 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700 rounded-lg overflow-hidden">
            <div className="bg-slate-100 dark:bg-slate-700 px-4 py-2 border-b border-slate-200 dark:border-slate-600">
              <span className="text-xs font-medium text-slate-600 dark:text-slate-400 uppercase tracking-wide">
                Exemplo • Linguagem Égua
              </span>
            </div>
            <div className="p-4">
              <pre className="text-slate-700 dark:text-slate-300 font-mono text-sm overflow-x-auto leading-relaxed">
