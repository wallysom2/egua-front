          ...
          <div className="bg-white dark:bg-slate-900 p-8 rounded-2xl shadow-xl border border-slate-200 dark:border-slate-800">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="flex items-center justify-between text-sm">
                <div className="flex items-center">
                  ...
                  />
                  <label htmlFor="lembrar" className="ml-2 text-slate-600 dark:text-slate-400">
                    Lembrar-me
                  </label>
                </div>
                <Link href="/recuperar-senha" className="text-blue-500 hover:text-blue-600 dark:text-blue-400 dark:hover:text-blue-300">
                  Esqueceu a senha?
                </Link>
              </div>
            ...
            <div className="mt-8 text-center">
              <p className="text-slate-600 dark:text-slate-400">
                Não tem uma conta?{" "}
                <Link href="/cadastro" className="text-blue-500 hover:text-blue-600 dark:text-blue-400 dark:hover:text-blue-300 font-medium">
                  Cadastre-se
                </Link>
              </p>
            </div>
