...
export default function Home() {
  ...
  return (
    <div ref={containerRef} className="min-h-screen flex flex-col bg-gradient-to-br from-slate-50 via-white to-slate-100 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950 text-slate-900 dark:text-white transition-colors">
      <ScrollProgress />
          ...
          <div className="flex items-center gap-4">
            ...
            >
              <Tooltip content="Acessar sua conta">
                <Link href="/login" className="px-6 py-2 rounded-lg bg-gradient-to-r from-blue-500 to-indigo-500 hover:from-blue-600 hover:to-indigo-600 transition-all flex items-center gap-2 shadow-lg text-white">
                  <svg 
      ...
      >
        <div className="container mx-auto px-6 text-center">
          ...
          >
            ...
            >
              {[
                { icon: "📚", text: "Aprenda", tooltip: "Conteúdo didático e estruturado" },
                { icon: "💻", text: "Pratique", tooltip: "Exercícios práticos e interativos" },
                { icon: "🚀", text: "Crie", tooltip: "Projetos reais para seu portfólio" }
              ].map((item, index) => (
                <motion.div
                  key={index}
            ...
            {[
              {
                ...
                description: "Interface intuitiva e conteúdo didático para iniciantes absolutos",
              ...
              },
              {
                ...
                description: "Acesso 24/7 ao conteúdo, você define seu próprio horário de estudos",
              ...
              },
              {
                ...
                description: "Conte com o apoio de outros estudantes e professores experientes",
      ...
      <section className="py-20">
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-4xl mx-auto text-center">
            {[
              { number: "100+", text: "Exercícios Práticos", color: "blue", tooltip: "Mais de 100 exercícios para praticar" },
              { number: "50+", text: "Lições Interativas", color: "green", tooltip: "Mais de 50 lições interativas" },
              { number: "24/7", text: "Sempre Disponível", color: "purple", tooltip: "Acesso ilimitado ao conteúdo" },
              { number: "∞", text: "Possibilidades", color: "yellow", tooltip: "Inúmeras possibilidades de aprendizado" }
            ].map((stat, index) => (
              <motion.div
                key={index}
        ...
        >
          <div className="max-w-3xl mx-auto">
            ...
            <motion.p 
              ...
              whileHover={{ scale: 1.02 }}
            >
              Junte-se a milhares de estudantes que já estão aprendendo programação com o Égua
            </motion.p>
            <motion.div
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
